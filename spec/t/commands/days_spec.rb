...
E_T
    ...
    it { expect(lines[1]).to  eq "2013-08-04 - 2013-08-10 |     |     |     |     |     |     |     |     0" }
    it { expect(lines[2]).to  eq "2013-08-11 - 2013-08-17 |  61 |     |     |     |     |     |     |    61" }
    it { expect(lines[3]).to  eq "2013-08-18 - 2013-08-24 |     |     |     |     |  62 |     |     |    62" }
    it { expect(lines[4]).to  eq "2013-08-25 - 2013-08-31 |     |     |     |     |     |     |  63 |    63" }
    skip { expect(lines[5]).to  eq "2013-08                 |  61 |     |     |     |  30 |  29 |     |    59" }
    skip { expect(lines[6]).to  eq "2013-09-01 - 2013-09-07 |     |     |     |     |     |     |     |     0" }
    skip { expect(lines[7]).to  eq "2013-09                 |     |     |     |     |     |     |     |     0" }
    skip { expect(lines[8]).to  eq "2013                    |     |     |     |     |     |     |     |     0" }
    skip { expect(lines[9]).to  be_nil }
  end
end
