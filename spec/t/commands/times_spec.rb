...
E_T
    ...
    it { expect(lines[7]).to  eq "2013-09-01 - 2013-09-07 ||       |       |       | 10:45 | 11:26 |       |       |" }
    it { expect(lines[8]).to  eq "2013-09                 ||       |       |       | 10:45 | 11:26 |       |       |" }
    it { expect(lines[9]).to  eq "2013                    || 10:45 |       |       | 10:45 | 10:45 | 10:15 | 10:45 |" }
